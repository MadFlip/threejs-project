...
let scene, camera, renderer, hlight, directionalLight, light, light2, controls, circle, house;
...
function animate() {
    ...
    circle.rotation.y = Math.atan2( ( camera.position.x - circle.position.x ), ( camera.position.z - circle.position.z ) );
    controls.update();
...
function watchMouse () {
  ...
  if (useRaycast) {
      ...
      hits = raygun.intersectObject(circle, false);
